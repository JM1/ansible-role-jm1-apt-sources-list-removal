# Ansible Role `jm1.apt_sources_list_removal`
...
Available on Ansible Galaxy: [jm1.apt_sources_list_removal](https://galaxy.ansible.com/jm1/apt_sources_list_removal)
